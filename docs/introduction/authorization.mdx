...
<Note>Partner tokens should never be shared with the frontend. Keep them secured on your server.</Note>
...
<Note>Firm tokens should never be shared with the frontend. Keep them secured on your server.</Note>
