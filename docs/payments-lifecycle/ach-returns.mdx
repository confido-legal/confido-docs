...
You can get notified when an ACH payment is returned by configuring the `transaction.ach_returned` webhook. See [webhooks](/docs/webhooks/overview) for more info.
