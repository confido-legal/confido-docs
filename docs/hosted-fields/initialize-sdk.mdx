...
Then initialize the sdk with the Payment Token. For a more detailed explanation of the `init()` method, see the [Hosted Fields SDK Reference Docs](/hosted-fields-js/initialize).
