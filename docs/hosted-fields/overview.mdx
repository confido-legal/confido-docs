...
-   You will need to handle each payment method and keep your implementation up to date as we release new payment methods (e.g., Buy Now, Pay Later, Apple Pay, crypto).
