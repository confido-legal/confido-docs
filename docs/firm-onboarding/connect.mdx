...
<Note>
    For users without a Confido Legal account, use [Sign Up Links](/docs/firm-onboarding/sign-up-links) or [Onboarding.js](/onboarding-js/overview).
</Note>
...
First we need to configure some settings in the Partner portal. Log in to the portal and go to Settings > Connect.
