...
Onboarding.js is a JavaScript library that lets you inject the Confido Legal onboarding form into any `div` on your page. This means your users never have to leave your app to get approved to accept payments.
...
4. The user fills out the form and **onboarding.js** communicates directly with Confido to submit data.
